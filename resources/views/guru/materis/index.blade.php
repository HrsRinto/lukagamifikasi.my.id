    ...
    <div class="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end md:items-center mb-10 gap-4 border-b border-gray-100 pb-8">
                ...
                {{-- Tombol Tambah Modul --}}
                <a href="{{ route('materis.create') }}" class="group relative inline-flex items-center justify-center px-8 py-3 font-bold text-white transition-all duration-200 bg-indigo-600 font-lg rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200 hover:shadow-indigo-300 hover:-translate-y-1">
                    <span class="mr-2 text-xl">+</span> Buat Modul Baru
                </a>
            </div>
                ...
                <div class="bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 hover:shadow-2xl hover:shadow-indigo-100/50 transition-all duration-300 group flex flex-col h-full overflow-hidden hover:-translate-y-1 relative">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="mt-auto pt-5 border-t border-dashed border-gray-100 w-full">
                            ...
                            {{-- Tombol Aksi --}}
                            <a href="{{ route('materis.show', $materi->id) }}" class="block w-full py-3 bg-gray-50 hover:bg-indigo-600 text-gray-700 hover:text-white rounded-xl font-bold text-sm text-center transition-all duration-200 group-hover:shadow-lg group-hover:shadow-indigo-200 border border-transparent hover:border-indigo-600">
                                ⚙️ Kelola Video & Soal
                            </a>
                        </div>
                    </div>
