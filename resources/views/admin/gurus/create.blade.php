        ...
        <div class="max-w-3xl mx-auto relative z-10">
            ...
            <div class="flex justify-between items-center mb-8 animate-fade-in-down">
                <div>
                    ...
                    <p class="mt-1 text-gray-500 text-sm">Masukkan kredensial untuk mendaftarkan staf pengajar baru.</p>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden relative animate-fade-in-up">
                ...
                <div class="p-8 md:p-10">
                    <form action="{{ route('gurus.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="name" required class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-sm focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder-gray-400" placeholder="Contoh: Drs. Budi Santoso, M.Pd">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="email" name="email" required class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-sm focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder-gray-400" placeholder="nama.guru@sekolah.com">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="password" name="password" required class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-sm focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder-gray-400" placeholder="••••••••">
                                </div>
                                <p class="mt-2 text-xs text-gray-500">Minimal 8 karakter. Guru dapat mengubah password mereka nanti.</p>
                            </div>
                        ...
                        <div class="mt-10 pt-6 border-t border-gray-100 flex items-center justify-end">
                            <button type="submit" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-blue-500/30 transform transition hover:-translate-y-0.5 focus:ring-4 focus:ring-blue-500/30">
                ...
                {{-- Info Box Bawah --}}
                <div class="bg-blue-50/50 p-4 border-t border-blue-100 flex items-start gap-3">
                    ...
                    <p class="text-xs text-blue-800 leading-relaxed">
                        Akun guru yang baru dibuat akan memiliki akses untuk <strong>mengelola modul materi</strong>, <strong>membuat soal kuis</strong>, dan <strong>mengatur event raid</strong>.
                    </p>
                </div>
